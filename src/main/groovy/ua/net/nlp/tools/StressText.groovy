...
@Grab(group='org.languagetool', module='languagetool-core', version='6.7')
@Grab(group='org.languagetool', module='language-uk', version='6.7')
...
//            println "making missing dir: $resourceDir"
        ...
        def basePkg = StressText.class.getPackageName()
        def tagTextClass = cl.loadClass("${basePkg}.stress.StressTextCore")
